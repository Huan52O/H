  ...
  <div style="margin: 25px 0; font-size: 0.8em; font-weight: 600;">
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">上证指数 4137.06</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+5.08</span> 
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">深证成指 14274.93</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+114</span> 
                ...
                <div>
                  <span style="color: #ff5252;">+38.82</span> 
                  <span style="color: #ff5252;">(+1.18%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">000300</span>
                  <span style="color: #aab2c0; margin-left: 15px;">沪深300 4722.4</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+8.58</span> 
                  <span style="color: #ff5252;">(+0.18%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399005</span>
                  <span style="color: #aab2c0; margin-left: 15px;">中小100 8658.33</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+33.04</span> 
