  ...
  <div style="margin: 25px 0; font-size: 0.8em; font-weight: 600;">
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">上证指数 4096.14</span>
                </div>
                <div>
                  <span style="color: #00e676;">-10.11</span> 
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">深证成指 15906.57</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+52.37</span> 
                  <span style="color: #ff5252;">(+0.33%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399006</span>
                  <span style="color: #aab2c0; margin-left: 15px;">创业板指 4209.9</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">沪深300 4925.42</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+6.03</span> 
                  <span style="color: #ff5252;">(+0.12%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399005</span>
                  <span style="color: #aab2c0; margin-left: 15px;">中小100 9572.65</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+97.19</span> 
    ...
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                ...
                <div>
                  <span style="color: #ff5252;">+3.19%</span> 
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
