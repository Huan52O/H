  ...
  <div style="margin: 25px 0; font-size: 0.8em; font-weight: 600;">
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">上证指数 4040.43</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+53.42</span> 
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">深证成指 15081.33</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+229.35</span> 
                  <span style="color: #ff5252;">(+1.54%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399006</span>
                  <span style="color: #aab2c0; margin-left: 15px;">创业板指 3864.19</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">沪深300 4794.35</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+71.94</span> 
                  <span style="color: #ff5252;">(+1.52%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399005</span>
                  <span style="color: #aab2c0; margin-left: 15px;">中小100 9094.37</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+147.36</span> 
    ...
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                ...
                <div>
                  <span style="color: #ff5252;">+1.90%</span> 
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
