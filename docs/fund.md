  ...
  <div style="margin: 25px 0; font-size: 0.8em; font-weight: 600;">
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">上证指数 4156.47</span>
                </div>
                <div>
                  <span style="color: #00e676;">-6.41</span> 
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">深证成指 14349.65</span>
                </div>
                <div>
                  <span style="color: #00e676;">-145.44</span> 
                  <span style="color: #00e676;">(-1%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399006</span>
                  <span style="color: #aab2c0; margin-left: 15px;">创业板指 3274.42</span>
                </div>
                <div>
                  <span style="color: #00e676;">-35.88</span> 
                  <span style="color: #00e676;">(-1.08%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">000300</span>
                  <span style="color: #aab2c0; margin-left: 15px;">沪深300 4695.69</span>
                </div>
                <div>
                  <span style="color: #00e676;">-14.96</span> 
                  <span style="color: #00e676;">(-0.32%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399005</span>
                  <span style="color: #aab2c0; margin-left: 15px;">中小100 8757.71</span>
                </div>
                <div>
                  <span style="color: #00e676;">-77.55</span> 
    ...
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                ...
                <div>
                  <span style="color: #00e676;">-1.92%</span> 
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
