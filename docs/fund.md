  ...
  <div style="margin: 25px 0; font-size: 0.8em; font-weight: 600;">
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">上证指数 3400.72</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+15.36</span> 
                ...
                <div>
                  ...
                  <span style="color: #aab2c0; margin-left: 15px;">深证成指 10250.29</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+66.59</span> 
                  <span style="color: #ff5252;">(+0.65%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399006</span>
                  <span style="color: #aab2c0; margin-left: 15px;">创业板指 2061.12</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+21.68</span> 
                  <span style="color: #ff5252;">(+1.06%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">000300</span>
                  <span style="color: #aab2c0; margin-left: 15px;">沪深300 3886.03</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+12.05</span> 
                  <span style="color: #ff5252;">(+0.31%)</span>
                </div>
              </div><div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
                <div>
                  <span style="color: #4c82ff; font-weight: 600;">399005</span>
                  <span style="color: #aab2c0; margin-left: 15px;">中小100 6399.44</span>
                </div>
                <div>
                  <span style="color: #ff5252;">+19.5</span> 
                  <span style="color: #ff5252;">(+0.31%)</span>
                </div>
              </div>
    <div style="display: flex; justify-content: space-between; padding: 18px; margin: 12px 0; background: rgba(255,255,255,0.03); border-radius: 8px; transition: transform 0.3s ease;">
