    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$111528.1</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.187)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥801552.45</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5170.78 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$111489</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$111408</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$4483.04</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.187)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥32219.61</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">165627.32 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$4507.81</div>
          </div>
          <div>
