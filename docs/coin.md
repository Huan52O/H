    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$111064</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.168)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥796106.75</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">6780.03 BTC</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$4315.79</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.168)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥30935.58</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">181613.98 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$4327.31</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$4416.94</div>
          </div>
          <div>
