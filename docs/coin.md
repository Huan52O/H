    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$93000</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.101)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥660393.00</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">9267.95 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$86802.9</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$86210</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$3045.15</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.101)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥21623.61</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">184518.70 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2807.65</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$3049.89</div>
          </div>
          <div>
