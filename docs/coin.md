    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$63468.1</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.758)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥428917.42</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5899.43 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$63527.1</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$64014.2</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$1884.29</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.758)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥12734.03</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">44918.66 ETH</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$1900</div>
          </div>
          <div>
