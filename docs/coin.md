    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$90515</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.101)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥642747.02</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">6548.71 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$91367.9</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$3005.01</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.101)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥21338.58</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">132165.75 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$3011</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$2993</div>
          </div>
          <div>
