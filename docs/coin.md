    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$79030.1</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.742)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥532820.93</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5192.94 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$77923.4</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2477.95</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.742)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥16706.34</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">89816.44 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2433.58</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$2431.43</div>
          </div>
          <div>
