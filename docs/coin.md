    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$78409.8</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.808)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥533813.92</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5762.70 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$80568.2</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$80768.1</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$78063.4</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">UTC 0时</span>
              <div style="font-size:16px;">$79116.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">UTC 8时</span>
              <div style="font-size:16px;">$79159.6</div>
          </div>
      </div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2195.13</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.808)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥14944.45</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">110891.77 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2254.49</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$2264.39</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$2181.62</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">UTC 0时</span>
              <div style="font-size:16px;">$2224.64</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">UTC 8时</span>
              <div style="font-size:16px;">$2222.78</div>
          </div>
      </div>
    </div>      
  </div>
