    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$91042</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.081)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥644668.40</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5134.13 BTC</div>
          </div>
          <div>
