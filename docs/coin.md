    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$86647.6</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.081)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥613551.66</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">6439.22 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$86776.1</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2831.7</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.081)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥20051.27</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">238918.52 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2936.59</div>
          </div>
          <div>
