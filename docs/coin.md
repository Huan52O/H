    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$63683</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.911)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥440113.21</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">10420.23 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$64703</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$63428.5</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$1832.6</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.911)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥12665.10</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">227412.32 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$1856.12</div>
          </div>
          <div>
