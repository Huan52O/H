    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$71007.3</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.894)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥489524.33</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">6426.91 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$71790.3</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2183.48</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.894)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥15052.91</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">131689.41 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2257.83</div>
          </div>
          <div>
