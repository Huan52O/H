    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$87748.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.056)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥619156.24</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">2928.91 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$87385</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2948.64</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.056)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥20805.60</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">90680.72 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2942.05</div>
          </div>
          <div>
