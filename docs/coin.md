    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$61665.4</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.791)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥418769.73</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">10139.25 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$61079.4</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$60862.1</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$1723.34</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.791)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥11703.20</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">184781.84 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$1643</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$1734.93</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$1638.17</div>
          </div>
          <div>
