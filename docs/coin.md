    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$117554.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.172)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥843103.74</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5078.74 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$117632</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2948.71</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.172)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥21148.15</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">127509.03 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2958.93</div>
          </div>
          <div>
