    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$68903.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.933)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥477710.74</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">7975.93 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$66460</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$66051.1</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2053.18</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.933)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥14234.70</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">212043.36 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$1945.54</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$1932.91</div>
          </div>
          <div>
