    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$66745.3</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.894)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥460142.10</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">1939.93 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$67007.7</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$67545.7</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$66606.7</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">UTC 0时</span>
              <div style="font-size:16px;">$67302.6</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">UTC 8时</span>
              <div style="font-size:16px;">$67379.5</div>
          </div>
      </div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2036.09</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.894)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥14036.80</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">40362.80 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2053.85</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$2084.05</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$2026.84</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">UTC 0时</span>
              <div style="font-size:16px;">$2065.57</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">UTC 8时</span>
              <div style="font-size:16px;">$2056.29</div>
          </div>
      </div>
    </div>      
  </div>
