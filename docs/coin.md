    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$64252.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(6.791)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥436341.44</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">4623.79 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$64284.1</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$1801.19</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(6.791)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥12231.88</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">82541.37 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$1784.8</div>
          </div>
          <div>
          ...
          <div>
              ...
              <div style="font-size:16px;">$1775.4</div>
          </div>
          <div>
