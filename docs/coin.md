    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$85537.5</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.081)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥605691.04</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">8185.20 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$86439.4</div>
          </div>
          <div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$2830.36</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.081)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥20041.78</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">239491.00 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$2835.5</div>
          </div>
          <div>
