    ...
    <div style="margin-bottom:15px; padding:15px; border:1px solid #00f7ff33; border-radius:8px;">
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#00ff88; font-size:24px; font-weight:700;">$115276.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">转换价(7.145)</span>
              <div style="color:#00ff88; font-size:24px; font-weight:700;">￥823653.45</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H量</span>
              <div style="font-size:18px;">5430.25 BTC</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$114389</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$116325.2</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$113417.5</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">UTC 0时</span>
              <div style="font-size:16px;">$115477.9</div>
          </div>
          <div>
              <span style="color:#00f7ff; font-size:12px;">UTC 8时</span>
              <div style="font-size:16px;">$114186.1</div>
          </div>
      </div>
      ...
      <div style="display:grid; grid-template-columns:repeat(2, 1fr); gap:10px;">
          <div>
              ...
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">$4537.77</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">转换价(7.145)</span>
              <div style="color:#ff4dff; font-size:24px; font-weight:700;">￥32422.37</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H量</span>
              <div style="font-size:18px;">165115.63 ETH</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H开盘</span>
              <div style="font-size:16px;">$4433.43</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最高</span>
              <div style="font-size:16px;">$4563.18</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">24H最低</span>
              <div style="font-size:16px;">$4351</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">UTC 0时</span>
              <div style="font-size:16px;">$4458.66</div>
          </div>
          <div>
              <span style="color:#ff00d2; font-size:12px;">UTC 8时</span>
              <div style="font-size:16px;">$4412.89</div>
          </div>
      </div>
    </div>      
  </div>
